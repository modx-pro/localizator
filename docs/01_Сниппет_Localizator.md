...
**localizatorTVs**				| Нет								| Список переведённых доп.полей. Если не заполнять, подтягиваются все TV с включённой опцией «Доступен в локализациях» в настройках TV; параметр позволяет сузить или задать список
