...
Актуальные возможности и настройки описаны в папке [docs/](docs/) (в т.ч. версии 1.0.9 и 1.1.0). Требуется pdoTools; для вывода TV в Fenom корректная работа с путями к файлам обеспечена с 1.1.0.
